...
1. Call `mcp__spec-to-pr__list_eval_suites`.
2. Call `mcp__spec-to-pr__run_eval_suite` for the default suite.
3. Call `mcp__spec-to-pr__run_security_hardening_suite`.
4. If failures exist, stop and report:
   - failing suite
   - failure reason
   - owning task or component
5. If evals and hardening pass, call `mcp__spec-to-pr__build_release_package`.
6. Call `mcp__spec-to-pr__verify_release_package`.
7. Call `mcp__spec-to-pr__generate_release_notes`.

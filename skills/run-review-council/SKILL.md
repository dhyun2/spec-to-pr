...
- component contracts against component-level visual evidence when component contracts exist
- Gherkin/test matrix coverage
- Legacy feature inventory against OpenSpec, Gherkin, target implementation, and test evidence when a legacy inventory artifact exists
- open gap policy

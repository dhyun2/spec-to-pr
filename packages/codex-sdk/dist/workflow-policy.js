export const DEFAULT_CODEX_VISUAL_REPAIR_POLICY = {
...
export const CODEX_REVIEW_AGENT_PROFILES = [
    {
        ...
        focus: "Figma baseline, browser screenshot, diff, overlay, masks, and design-contract evidence.",
        output: "Visual mismatch findings with target IDs, artifact IDs, severity, owner, and repair notes.",
    },
    {
    ...
    },
    {
        ...
        focus: "Lighthouse, bundle budgets, Web Vitals readiness, route coverage, and lab-vs-field wording.",
...
export function buildCodexReviewAgentInstructions(profiles = CODEX_REVIEW_AGENT_PROFILES) {
    return [
...
export function buildCodexVisualRepairInstructions(policy = {}) {
    const resolved = {

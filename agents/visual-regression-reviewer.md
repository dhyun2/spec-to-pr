...
- visual-report.json
- visual-report.md
- component-level visual reports with `comparisonScope: component`
...
- If component contracts exist, do not accept a full-screen visual pass as proof that component variants matched. Review the component crop/report separately.

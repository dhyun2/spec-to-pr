...
export const VisualComparisonScopeSchema = z.enum(["screen", "component"]);
...
export const VisualTargetSchema = z
  .object({
    ...
    comparisonScope: VisualComparisonScopeSchema.default("screen"),
    componentContractId: z.string().trim().min(1).optional(),
...
export const VisualBaselineModeSchema = z.enum(["figma", "legacy-screenshot"]);
...
export const VisualReportSchema = z
  .object({
    ...
    visualBaseline: VisualBaselineModeSchema.default("figma"),
    comparisonScope: VisualComparisonScopeSchema.default("screen"),
...
export type VisualBaselineMode = z.infer<typeof VisualBaselineModeSchema>;
export type VisualComparisonScope = z.infer<typeof VisualComparisonScopeSchema>;

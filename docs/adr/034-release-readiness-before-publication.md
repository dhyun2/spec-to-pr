...
The spec-to-pr plugin coordinates source ingestion, Figma evidence, OpenAPI analysis, agent execution, quality gates, visual regression, review scorecards, PR publishing, and OpenSpec archive.

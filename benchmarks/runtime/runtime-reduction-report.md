...
| Reviewer scheduling                  | Retained concurrent independent review. Controlled sample: 30 deliveries, 35 packet/fixture samples, five first failures, 300 ms invalidated of 2,100 ms reviewer wall (14.29%). Both reviewers remain available before the numeric visual verdict; this rework ratio is observed but never permits skipped review. No scheduling speedup claim is made. | `benchmarks/runtime/reviewer-scheduling-decision.json` (v3).                        |
